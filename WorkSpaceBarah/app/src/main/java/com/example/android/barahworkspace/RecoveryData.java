...
import com.example.android.barahworkspace.Database.DBHelper;
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (extras.getString("key").equals("cash"))
                        ...
                        locationFile = new File("/sdcard/BarahTotalCashRecovery.txt");
                     else if (extras.getString("key").equals("info"))
                        // Store Items Of Listview Into Text File.
                        locationFile = new File("/sdcard/BarahInformationRecovery.txt");
                     else
                        // Store Items Of Listview Into Text File.
                        locationFile = new File("/sdcard/BarahExtraCashNoteRecovery.txt");
